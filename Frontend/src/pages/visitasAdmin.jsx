    ...
    <div className="container-fluid p-0">
      ...
      <div className="d-flex align-items-center justify-content-between px-3 py-2">
        <div className="d-flex align-items-center">
          <button
            id="menuToggle"
            className="btn text-dark fs-4 border-0 m-0 px-3"
          >
            ☰
          </button>
        </div>
      ...
      <td>
        <img src={moto} alt="Moto" width="24" height="24" title="Motocicleta" />
      </td>
        ...
        <div className="d-flex align-items-center gap-3 mb-4">
          ...
          <div className="mb-4">
            ...
            <ul className="nav flex-column mt-2 gap-2">
              ...
              <li>
                <p className="nav-link text-white">Historial de Paquetes</p>
              </li>
            </ul>
          </div>
          ...
          <div className="mb-4">
            ...
            <ul className="nav flex-column mt-2 gap-2">
              ...
              <li>
                <p className="nav-link text-white">Consultar Visitas</p>
              </li>
              <li>
      ...
      <p>
        hola que mas <Link to="/">Regresar a App </Link>
      </p>
    </div>
  );
}
